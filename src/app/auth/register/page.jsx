...
const Register = () => {
   ...
   return (
      <>
         <section className="w-full min-h-[100vh] flex justify-center flex-col items-center py-10">
            <div className="w-full max-w-screen-sm p-6 shadow-xl rounded">
               ...
               <form ref={inputRef} onSubmit={handleSubmit} className="bg-white px-8 pt-6 pb-8 mb-4">
                  <div className="mb-4">
                     ...
                     <input name="username" className="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username" required />
                  </div>
                  <div className="mb-4">
                     <label className="block text-gray-700 text-sm font-semibold mb-2" htmlFor="email">
                        Email
                     </label>
                     <input name="email" className="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Email" required />
                  </div>
                  <div className="mb-6">
                  ...
                  <div className="flex items-center justify-between">
                     ...
                     <Link href="/auth/login" className="text-right ml-2 max-w-2/4 inline-block align-baseline font-bold text-sm text-gray-500 hover:text-[#EB8426]">
