...
const Login = () => {
   ...
   return (
      <MainLayout>
         <section className="w-full my-5 bg-[#FDFDFD] flex justify-center flex-col items-center py-10">
            <div className="w-full max-w-screen-sm p-6 shadow-xl rounded">
               ...
               <form ref={inputRef} onSubmit={handleSubmit} className="bg-white px-8 pt-6 pb-8 mb-4">
                  <div className="mb-4">
                     ...
                     <input name="username" className="text-md shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-0 focus:border-[#EB6D20]" id="username" type="text" placeholder="Username" required/>
                  </div>
                  <div className="mb-6">
                  ...
                  <div className="flex items-center justify-between">
                     ...
                     <Link href="/auth/register" className="text-right ml-2 max-w-2/4 inline-block align-baseline font-medium text-sm text-gray-500 hover:text-[#EB8426]">
                     Don't have account?
                     </Link>
                  </div>
               </form>
